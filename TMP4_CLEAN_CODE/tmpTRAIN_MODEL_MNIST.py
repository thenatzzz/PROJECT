...
def train_model_mnist(single_model):
  file = MAIN_FILE
  ...
  file_name = MAIN_FILE
  save_trained_model_in_csv(file_name,temp_single_model,eval_results)
...
def pre_train_model_mnist(file_name):
