...
def train(action_array):
  ...
  mnist_classifier = tf.estimator.Estimator(
      ...
      "/vol/bitbucket/nj2217/PROJECT_4/mnist_convnet_model"+ \
      "_"+str(model_index))
  ...
  path_to_file = "/homes/nj2217/PROJECT/REINFORCEMENT_algo/Test_model/"
  csv_file = path_to_file+"model_dict2.csv"
