...
def main(unused_argv):
  ...
  # while global_index < 20:
      ...
      # list_of_accuracy.append(eval_results['Accuracy'])
      print("\n####################### FINISIH TRAINING MODEL: ",temp_dict['Model'], " : #########################")
      print('\n\n\n')

    #  fn_to_change_content(eval_results['accuracy'], eval_results['loss'])

      global_index += 1


  # csv_file = "MODEL_2.csv"
  # csv_file = "MODEL.csv"
  path_to_file = "/vol/bitbucket/nj2217/PROJECT_1/"
  csv_file = path_to_file+"MODEL_dict_1.csv"
